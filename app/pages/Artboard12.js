...
class Artboard12 extends Component{
    ...
    constructor(props) {
        ...
        this.state= {
            books:[
                {type:'كلاسيك', date:'السبت 26 يناير 2019', src_des:'من الرياض الي المدينة', number:'2 فرد', trip_num:532963},
                {type:'كلاسيك', date:'السبت 26 يناير 2019', src_des:'من الرياض الي المدينة', number:'2 فرد', trip_num:532963},
                {type:'كلاسيك', date:'السبت 26 يناير 2019', src_des:'من الرياض الي المدينة', number:'2 فرد', trip_num:532963},
                {type:'كلاسيك', date:'السبت 26 يناير 2019', src_des:'من الرياض الي المدينة', number:'2 فرد', trip_num:532963},
                {type:'كلاسيك', date:'السبت 26 يناير 2019', src_des:'من الرياض الي المدينة', number:'2 فرد', trip_num:532963},
                ...
                <View style={{justifyContent:'center', alignItems:'center'}}>
                    <View style={{marginVertical:hp('2%'), borderColor:'#7E7560', borderWidth:wp('0.2%'), width:wp('84%'), height:hp('5%'), flexDirection:'row'}}>                   
                        <TouchableOpacity disabled={true}>
                            <Text style={{width:wp('42%'), height:hp('4.9%'), backgroundColor:'rgba(152, 145, 128, 0.7)', textAlignVertical:'center', textAlign:'center', fontSize:wp('4%'), fontWeight:'500', color:'white'}}> حجوزات حالية </Text>
                        </TouchableOpacity>
                        <TouchableOpacity>
                            <Text style={{width:wp('42%'), height:hp('4.9%'), backgroundColor:'rgba(255, 255, 255, 0.7)', textAlignVertical:'center', textAlign:'center', fontSize:wp('4%'), fontWeight:'500', color:'#989180'}}> حجوزات سابقة </Text>
                        </TouchableOpacity>
                    </View>
                </View>
                <View style={{justifyContent:'center', alignItems:'center'}}>
                    ...
                    renderItem={({item}) =>{
                        ...
                        <View style={{borderRadius:wp('2%'), borderColor:'#7E7560', borderWidth:wp('0.2%'), height:hp('20%'), width:wp('84%'), margin:hp('1%')}}>
                            ...
                            <View style={{position:'absolute', flexDirection:'row', bottom:wp('1%'), left:wp('1%')}}>
                                <TouchableOpacity>                        
                                    <Image source={Edit} style={{width:wp('7%'), height:wp('7%'), resizeMode:'contain', margin:wp('1%')}}/>
                                </TouchableOpacity>
                                <TouchableOpacity>
                                    <Image source={Delete} style={{width:wp('7%'), height:wp('7%'), resizeMode:'contain', margin:wp('1%')}}/>
                                </TouchableOpacity>
                            </View>
                        </View>
                        )
